...
var Desktop = /** @class */ (function (_super) {
    ...
    function Desktop(_a) {
        var _b = _a.backgroundColor, backgroundColor = _b === void 0 ? "#4FC3F7" : _b, _c = _a.mainElement, mainElement = _c === void 0 ? document.body : _c;
        var _this = _super.call(this, "desktop", "desktop") || this;
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        setTimeout(function () { bootscreen.unload(); }, 5000);
                        return [2 /*return*/];
                }
            });
        });
