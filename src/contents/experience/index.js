...
var ExperienceContent = /** @class */ (function (_super) {
    __extends(ExperienceContent, _super);
    function ExperienceContent() {
        var _this = _super.call(this, "experiencecontent", "experience-content") || this;
        var element = new DOMParser().parseFromString(content, "text/html").body.childNodes[0];
        var loader = element.querySelector(".content");
        var experiences = experience.map(function (experience) { return new ExperiencesContent(experience); });
        experiences.forEach(function (experience) { return experience.load(loader); });
